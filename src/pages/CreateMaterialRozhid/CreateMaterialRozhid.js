...
import s from "./CreateMaterialRozhid.module.css";
import { connect } from "react-redux";
import { withFormik } from "formik";
import {
  createMaterialsAction,
  createMaterialsRozhidAction,
...
const mapDispatchToProps = (dispatch) => {
  return {
    createWorker: (materialsRozhid) =>
      dispatch(createMaterialsRozhidAction(materialsRozhid)),
