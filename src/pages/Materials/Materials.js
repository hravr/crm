                          ...
                          <td>
                            <div className={s.table__btn}>
                              <button
                                className={s.del}
                                onClick={() =>
                                  h.push(`/edit-materials-pruhid/${zvit._id}`)
                                }
                              >
                                Редагувати
                              </button>
                          ...
                          <td>
                            <div className={s.table__btn}>
                              <button
                                className={s.del}
                                onClick={() =>
                                  h.push(`/edit-materials-pruhid/${filter._id}`)
                                }
                              >
                                Редагувати
                              </button>
                    ...
                    if (zvitRozxid.date_rozxodu) {
                      return (
                        <tr key={zvitRozxid._id}>
                          ...
                          <td>{zvitRozxid.price}</td>
                          <td>{zvitRozxid.vendorId?.name}</td>
                          <td>
                            <div className={s.table__btn}>
                              <button
                                onClick={() =>
                                  deleteZvituRozxid(zvitRozxid._id)
                                }
                              >
                                Видалити
                              </button>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    filterZvituZalushok: (data) =>
      dispatch(filterMaterialsZalushokAction(data)),
  };
};
